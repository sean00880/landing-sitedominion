  ...
  return (
    <Box {...sectionWrapper}>
      <Container>
        <Box {...row}>
          <Box {...col} {...imageArea}>
            <NextImage src={Domains} alt="Domain Image" />
          </Box>
          <Box {...col} {...textArea}>
            <Fade bottom cascade>
              <Heading
              ...
              <Text
                {...description}
                content="You can check the domain availability by our domain tool and choose your desired domain without any hesitation if available."
              />
              <Box>
                <Link href="#">
                  <a>
