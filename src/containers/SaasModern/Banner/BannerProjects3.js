...
import BannerImage from 'common/assets/image/saasModern/metanetic2.png';
      ...
      <Container>
        <Box {...row}>
          <Box {...contentWrapper}>
            <Heading
              {...title}
              content="Metanetic - A Digital Marketing Agency"
            />
            <Text
              {...description}
              content="Metanetic is a Dubai-based Digital Marketing Agency."
            />
          </Box>
          <Box {...imageWrapper}>
            <Fade bottom>
